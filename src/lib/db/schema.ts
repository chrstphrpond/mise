...
// Better Auth tables (default shape — keep names singular and field names
// exact so the drizzle-adapter recognizes them).
...
export const outlets = pgTable("outlets", {
  ...
  ownerId: text("owner_id").notNull(), // Better Auth user.id, or "demo" for the cookie path
